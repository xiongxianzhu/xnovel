...
from sqlalchemy import CheckConstraint, Column, DateTime, Index, Text, UniqueConstraint, text
...
class Project(TimestampMixin, table=True):
    ...
    __table_args__ = (
        CheckConstraint("length(title) BETWEEN 1 AND 200", name="ck_projects_title_length"),
