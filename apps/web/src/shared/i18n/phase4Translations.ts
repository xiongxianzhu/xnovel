export const phase4Translations = {
  "zh-CN": {
    ai: {
      ...
      providerSearchPlaceholder: "搜索名称、提供商ID 或地址",
      details: "详情",
      ...
      customProviderId: "提供商ID",
      customProviderIdRequired: "请输入小写字母开头的提供商ID",
      protocol: "协议",
  ...
  "zh-TW": {
    ai: {
      ...
      providerSearchPlaceholder: "搜尋名稱、供應商ID 或位址",
      details: "詳情",
      ...
      customProviderId: "供應商ID",
      customProviderIdRequired: "請輸入以小寫字母開頭的供應商ID",
      protocol: "協定",
